...
var ConverterPipe = (function () {
    //Creacion de Pipes personalizadas
    function ConverterPipe() {
    }
    ConverterPipe.prototype.transform = function (firstValue, secondValue) {
        var result = 'La multiplicacion:' + firstValue + ' x ' + secondValue + ' = ' + (firstValue * secondValue);
        return result;
    };
